...
export const salaryAgreements: Record<AgreementId, SalaryAgreement> = {
  sokkel4a2025: {
    ...
    groups: {
      S: {
        monthly: [65886.33, 67002.42, 68118.42, 69234.5, 70350.58, 71466.67, 72582.75, 73698.83, 74814.92, 76645.25, 77761.33],
        hourly: [505, 514, 523, 531, 540, 548, 557, 565, 574, 588, 597],
        overtime: [834, 848, 862, 876, 890, 905, 919, 933, 947, 970, 984],
      },
      F: {
        monthly: [63728.58, 64695.83, 65663.08, 66630.33, 67597.58, 68564.92, 69532.17, 70499.42, 71466.67, 73297, 74413.08],
        hourly: [489, 496, 504, 511, 519, 526, 533, 541, 548, 562, 571],
        overtime: [807, 819, 831, 843, 856, 867.9, 880, 893, 905, 928, 942],
      },
    },
  },
  safe2025: {
